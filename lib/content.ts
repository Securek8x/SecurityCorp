...
{index:"P-02",title:"VPN-Isolated Workloads",status:"Operational",text:"A shared-network-namespace design with controlled LAN access, verified tunnel egress, and kill-switch regression checks.",tags:["VPN Isolation","Networking","Containers"],
